...
import com.ex.pelicula.ui.HomePageFragment


class AdapterHomePage(var movieList: List<Movie>
    ...
    inner class MovieViewHolder(private val binding: FragmentHomePageItemBinding) : RecyclerView.ViewHolder(binding.root) {
